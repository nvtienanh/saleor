...
from vanphong.core.prices import quantize_price
from vanphong.payment import PaymentError
from vanphong.payment.gateways.adyen.utils.common import (
    append_klarna_data,
    from_adyen_price,
...
from vanphong.payment.interface import PaymentMethodInfo
...
@mock.patch("vanphong.payment.gateways.adyen.utils.common.checkout_line_total")
...
@mock.patch("vanphong.payment.gateways.adyen.utils.common.append_klarna_data")
