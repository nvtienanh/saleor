...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.authenticate_test")
...
@pytest.mark.vcr()
def test_payment_gateway_validate_roomion(authorize_net_plugin):
...
@pytest.mark.integration
@pytest.mark.vcr()
def test_payment_gateway_process_payment_roomion_failure(
...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.refund")
...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.authorize")
...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.capture")
...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.process_payment")
...
@mock.patch("vanphong.payment.gateways.authorize_net.plugin.list_client_sources")
