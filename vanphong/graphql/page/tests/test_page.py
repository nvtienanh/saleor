...
def test_get_page_with_sorted_attribute_values(
    ...
    page,
    room_list,
    page_type_room_reference_attribute,
    permission_manage_pages,
):
    # given
    page_type = page.page_type
    page_type.page_attributes.set([page_type_room_reference_attribute])

    attr_value_1 = AttributeValue.objects.create(
        attribute=page_type_room_reference_attribute,
        name=room_list[0].name,
        slug=f"{page.pk}_{room_list[0].pk}",
    )
    attr_value_2 = AttributeValue.objects.create(
        attribute=page_type_room_reference_attribute,
        name=room_list[1].name,
        slug=f"{page.pk}_{room_list[1].pk}",
    )
    attr_value_3 = AttributeValue.objects.create(
        attribute=page_type_room_reference_attribute,
        name=room_list[2].name,
        slug=f"{page.pk}_{room_list[2].pk}",
    )

    attr_values = [attr_value_2, attr_value_1, attr_value_3]
    associate_attribute_values_to_instance(
        page, page_type_room_reference_attribute, *attr_values
    )
...
def test_create_page_with_room_reference_attribute(
    staff_api_client,
    permission_manage_pages,
    page_type,
    page_type_room_reference_attribute,
    ...
    ref_attribute_id = graphene.Node.to_global_id(
        "Attribute", page_type_room_reference_attribute.pk
    )
    page_type.page_attributes.add(page_type_room_reference_attribute)
    reference = graphene.Node.to_global_id("Room", room.pk)

    values_count = page_type_room_reference_attribute.values.count()
    ...
    _, new_page_pk = graphene.Node.from_global_id(page_id)
    expected_attr_data = {
        "attribute": {"slug": page_type_room_reference_attribute.slug},
        "values": [
            {
                "slug": f"{new_page_pk}_{room.pk}",
                "file": None,
                "name": room.name,
                "reference": reference,
            }
    ...
    page_type_room_reference_attribute.refresh_from_db()
    assert page_type_room_reference_attribute.values.count() == values_count + 1


def test_create_page_with_room_reference_attribute_not_required_no_references_given(
    staff_api_client,
    permission_manage_pages,
    page_type,
    page_type_room_reference_attribute,
    ...
    page_type_room_reference_attribute.value_required = False
    page_type_room_reference_attribute.save(update_fields=["value_required"])
...
def test_create_page_with_room_reference_attribute_required_no_references_given(
    staff_api_client,
    permission_manage_pages,
    page_type,
    page_type_room_reference_attribute,
    ...
    page_type_room_reference_attribute.value_required = True
    page_type_room_reference_attribute.save(update_fields=["value_required"])
...
def test_update_page_with_room_reference_attribute_new_value(
    staff_api_client,
    permission_manage_pages,
    page,
    page_type_room_reference_attribute,
...
def test_update_page_with_room_reference_attribute_existing_value(
    staff_api_client,
    permission_manage_pages,
    page,
    page_type_room_reference_attribute,
    ...
    associate_attribute_values_to_instance(
        page, page_type_room_reference_attribute, attr_value
    )
    ...
    page_type_room_reference_attribute.refresh_from_db()
    assert page_type_room_reference_attribute.values.count() == values_count
