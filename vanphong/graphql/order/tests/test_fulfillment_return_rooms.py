...
mutation OrderFulfillmentReturnRooms(
    $order: ID!, $input: OrderReturnRoomsInput!
) {
    orderFulfillmentReturnRooms(
        order: $order,
        input: $input
    ) {
        returnFulfillment{
...
def test_fulfillment_return_rooms_order_without_payment(
    ...
    data = content["data"]["orderFulfillmentReturnRooms"]
...
def test_fulfillment_return_rooms_amount_and_shipping_costs(
    mocked_refund,
    staff_api_client,
...
@patch("vanphong.order.actions.gateway.refund")
def test_fulfillment_return_rooms_order_lines(
    mocked_refund,
    staff_api_client,
    permission_manage_orders,
    order_with_lines,
...
def test_fulfillment_return_rooms_order_lines_quantity_bigger_than_total(
...
def test_fulfillment_return_rooms_order_lines_quantity_bigger_than_unfulfilled(
    staff_api_client, permission_manage_orders, order_with_lines, payment_dummy
):
    payment_dummy.total = order_with_lines.total_gross_amount
    payment_dummy.captured_amount = payment_dummy.total
...
@patch("vanphong.order.actions.gateway.refund")
def test_fulfillment_return_rooms_order_lines_custom_amount(
    mocked_refund,
    staff_api_client,
    permission_manage_orders,
    order_with_lines,
...
@patch("vanphong.order.actions.gateway.refund")
def test_fulfillment_return_rooms_fulfillment_lines(
    mocked_refund,
    staff_api_client,
    permission_manage_orders,
    fulfilled_order,
...
def test_fulfillment_return_rooms_fulfillment_lines_quantity_bigger_than_total(
...
def test_fulfillment_return_rooms_amount_bigger_than_captured_amount(
    staff_api_client, permission_manage_orders, fulfilled_order, payment_dummy
):
    payment_dummy.total = fulfilled_order.total_gross_amount
    payment_dummy.captured_amount = payment_dummy.total
...
def test_fulfillment_return_rooms_lines_with_incorrect_status(
    staff_api_client, permission_manage_orders, fulfilled_order, payment_dummy
):
    payment_dummy.total = fulfilled_order.total_gross_amount
    payment_dummy.captured_amount = payment_dummy.total
...
@patch("vanphong.order.actions.gateway.refund")
def test_fulfillment_return_rooms_fulfillment_lines_include_shipping_costs(
    mocked_refund,
    staff_api_client,
    permission_manage_orders,
    fulfilled_order,
...
@patch("vanphong.order.actions.gateway.refund")
def test_fulfillment_return_rooms_fulfillment_lines_and_order_lines(
    mocked_refund,
    hotel,
    variant,
    channel_USD,
