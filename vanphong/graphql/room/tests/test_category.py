...
def test_query_category_room_visible_in_listings_as_staff_without_manage_rooms(
...
def test_query_category_room_only_visible_in_listings_as_app_without_manage_rooms(
