...
class AttributeAssignmentMixin:
    ...
    REFERENCE_VALUE_NAME_MAPPING = {
        ...
        AttributeEntityType.ROOM: "name",
    }

    ENTITY_TYPE_TO_MODEL_MAPPING = {
        AttributeEntityType.PAGE: page_models.Page,
        AttributeEntityType.ROOM: room_models.Room,
    }
    ...
    def clean_input(
        ...
        """
        error_class = PageErrorCode if is_page_attributes else RoomErrorCode
...
class AttributeInputErrors:
    ...
    All used error codes must be specified in PageErrorCode and RoomErrorCode.
    """
