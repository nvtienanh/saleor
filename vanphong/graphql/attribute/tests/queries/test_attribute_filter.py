...
def test_filter_attributes_in_category_not_in_listings_by_staff_without_manage_rooms(
    staff_api_client,
    room_list,
    weight_attribute,
    channel_USD,
...
def test_filter_attributes_in_category_not_in_listings_by_app_without_manage_rooms(
    app_api_client,
    room_list,
    weight_attribute,
    channel_USD,
...
def test_filter_attributes_in_category_not_published_by_staff_without_manage_rooms(
    staff_api_client,
    room_list,
    weight_attribute,
    channel_USD,
...
def test_filter_attributes_in_category_not_published_by_app_without_manage_rooms(
    app_api_client,
    room_list,
    weight_attribute,
    channel_USD,
...
def test_filter_in_collection_not_published_by_staff_without_manage_rooms(
    staff_api_client,
    room_list,
    weight_attribute,
    collection,
...
def test_filter_in_collection_not_published_by_app_without_manage_rooms(
    app_api_client,
    room_list,
    weight_attribute,
    collection,
